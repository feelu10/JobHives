            ...
            <div class="-my-6">
                @foreach($listings as $listing)
                    <a
                        ...
                        class="border-x mx py-6 px-4 flex flex-wrap md:flex-nowrap  border-gray-100 {{ $listing->is_highlighted ? 'bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500' : 'bg-white hover:bg-gray-100' }}"
                    >
...
<!--=============== SWIPER JS ===============-->
<script src="{{ asset('merge/assets/js/swiper-bundle.min.js') }}"></script>
<!--=============== MAIN JS ===============-->
