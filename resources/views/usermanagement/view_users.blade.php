            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a class="textx" href="{{ route('dashboard') }}">Dashboard</a></li>
            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group has-icon-lefts">
                                            <div class="position-relative">
                                                <input type="file" class="form-control"placeholder="Name" id="first-name-icon" name="image"/>
                                            ...
                                            <fieldset class="form-group">
                                                <select class="form-select" name="role_name" id="role_name">
                                                    @foreach ($roleName as $key => $value)
                                                        <option value="{{ $value->role_type }}" {{ Auth::user()->role === $value->role_type ? 'selected' : '' }}>
                                                            {{ $value->role_type }}
                                                        </option>
                                                    @endforeach  
                                                </select>
                        ...
                        @endif
                        @if (Auth::user()->role_name=='Employee' || Auth::user()->role_name=='User' || Auth::user()->role_name=='Employer')
                        <form class="form form-horizontal" action="{{ route('update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{ $data[0]->id }}">
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8" type="hidden" >
                                        <div class="form-group position-relative has-icon-left mb-4" type>
                                            <fieldset class="form-group">
                                    ...
                                    <div class="col-12 d-flex justify-content-end">
                                        <button type="submit"
                                            class="btnx btn btn-primary me-1 mb-1">Update</button>
                                        <a  href="{{ route('userManagement') }}"
                                            class="btn btn-light-secondary me-1 mb-1">Back</a>
                                    </div>
                                </div>
